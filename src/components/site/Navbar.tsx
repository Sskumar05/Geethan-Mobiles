      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8 h-16 lg:h-20 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2 group">
          ...
          <div className="leading-tight">
            <div className={`font-bold text-lg ${scrolled ? "text-ink" : "text-white"}`}>
          ...
          {links.map((l) => (
            <a
              ...
              className={`relative px-4 py-2 text-sm font-medium transition-colors group ${
                scrolled ? "text-ink hover:text-samsung-bright" : "text-white/90 hover:text-white"
              }`}
            >
              {l.label}
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className={`w-10 h-10 grid place-items-center rounded-full transition-colors ${
              scrolled ? "hover:bg-muted text-ink" : "hover:bg-white/10 text-white"
            }`}
          >
          ...
          <button
            ...
            className={`lg:hidden w-10 h-10 grid place-items-center rounded-full transition-colors ${
              scrolled ? "hover:bg-muted text-ink" : "hover:bg-white/10 text-white"
            }`}
          >
